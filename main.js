...
var $author$project$Main$FahreinheitToCelsius = function (a) {
	return {$: 'FahreinheitToCelsius', a: a};
};
...
var $author$project$Main$getFahrenheitFieldValidOrNot = function (model) {
	return model.fahrenheitFieldValid ? _List_fromArray(
		[
			$elm$html$Html$Attributes$class('input')
		]) : _List_fromArray(
		[
...
var $author$project$Main$formatTemperature = function (number) {
	return A2(
...
var $author$project$Main$viewCelsius = function (model) {
	return model.celsiusFieldValid ? $author$project$Main$formatTemperature(model.celsius) : model.celsiusFieldValue;
};
var $author$project$Main$viewFahrenheit = function (model) {
	return model.fahrenheitFieldValid ? $author$project$Main$formatTemperature(model.fahrenheit) : model.fahrenheitFieldValue;
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Temperature Converter')
							])),
						A2(
						$elm$html$Html$h2,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Converting from Fahrenheit to Celsius')
							])),
						A2(
						$elm$html$Html$label,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for('Fahrenheit'),
						...
						_Utils_ap(
							_List_fromArray(
								[
									$elm$html$Html$Attributes$name('Fahrenheit'),
									$elm$html$Html$Attributes$class('input'),
									$elm$html$Html$Attributes$type_('text'),
									$elm$html$Html$Events$onInput($author$project$Main$FahreinheitToCelsius),
									$elm$html$Html$Attributes$value(
									$author$project$Main$viewFahrenheit(model))
								]),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for('Celsius'),
								$elm$html$Html$Attributes$class('label')
							]),
						_List_fromArray(
							[
						...
						_Utils_ap(
							_List_fromArray(
								[
									$elm$html$Html$Attributes$name('Celsius'),
									$elm$html$Html$Attributes$class('input'),
									$elm$html$Html$Attributes$type_('text'),
									$elm$html$Html$Events$onInput($author$project$Main$CelsiusToFahrenheit),
									$elm$html$Html$Attributes$value(
