		...
		switch (msg.$) {
			...
			default:
				return _Utils_update(
					model,
					{
						fizzBuzzModel: $author$project$FizzBuzz$updateFizzBuzzModel(model.fizzBuzzModel)
					});
		}
	});
...
var $author$project$Main$FizzBuzz = {$: 'FizzBuzz'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$FizzBuzz)
							]),
						_List_fromArray(
							[
